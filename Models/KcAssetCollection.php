...
/**
 * Class KcAssetCollection
 * @package Cx\DjbKc
 *
 */
class KcAssetCollection extends CxResourceBaseModel
{
    ...
    /**
     * Returns value of field collection_id
     *
     * @return int
     */
    ...
    /**
     * Method to set value of field collection_id
     *
    ...
    public function initialize() {
        ...
        $this->belongsTo('collection_id', KcCollection::class, 'id', array('alias' => 'KcCollection', 'foreignKey' => true));
    ...
    public static function getClassResourceActions() {
        return [
            'CREATE' => 'Create new Kc Asset Collection',
            'VIEW' => 'View Kc Asset Collection',
            'EDIT' => 'Edit Kc Asset Collection'
        ];
    }
}