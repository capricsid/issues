 ...
 *
 */
class KcCollection extends CxResourceBaseModel
{
    ...
    public function initialize() {
        ...
        $this->hasManyToMany(
            'id', KcAssetCollection::class, 'collection_id',
    ...
    public static function getClassResourceActions() {
        return [
            'CREATE' => 'Create new Kc Collection',
            'VIEW' => 'View Kc Collection',
            'EDIT' => 'Edit Kc Collection'
        ];
    }
}